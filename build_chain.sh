...
download_released_artifact(){
    ...
    local download_link="https://osp-1257653870.cos.ap-guangzhou.myqcloud.com/FISCO-BCOS/FISCO-BCOS/releases/\${version}/\${package_name}"
...
download_bin()
{
    ...
    Download_Link="https://osp-1257653870.cos.ap-guangzhou.myqcloud.com/FISCO-BCOS/FISCO-BCOS/releases/v${compatibility_version}/${package_name}"
